package org.canopyplatform.canopy.reportservice.auth.core;

import org.canopyplatform.canopy.reportservice.auth.AuthCapability;
import org.canopyplatform.canopy.reportservice.auth.UserAuthenticationException;
import org.canopyplatform.canopy.reportservice.auth.UserAuthorizationException;
import org.canopyplatform.canopy.reportservice.auth.AccessRole;
import org.canopyplatform.canopy.reportservice.auth.AuthLookupStatusRepository;
import org.canopyplatform.canopy.reportservice.auth.AuthRole;
import org.canopyplatform.canopy.reportservice.auth.AuthUser;
import org.canopyplatform.canopy.reportservice.auth.AuthUserRepository;
 ...
 *     Integer userId = authenticationService.checkCapability(jwt, "metrics.hub-content.view");
 *     // ... admin only logic
 * }
 * }
 * </pre>
